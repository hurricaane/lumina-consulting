...
defineProps(getSliceComponentProps<Content.AtelierSlice>());
...
<template>
  ...
  >
    ...
    <!-- ══ MANIFESTO ═════════════════════════════════════════════════════ -->
    <section
      v-if="isFilled.richText(slice.primary.manifesto)"
    ...
    >
      ...
      <UContainer>
        <motion.div
          class="max-w-3xl mx-auto text-center relative z-10"
        ...
        >
          ...
          <span
            aria-hidden="true"
            class="font-display italic text-lumina-300/15 select-none block"
            style="font-size: clamp(6rem, 14vw, 10rem); line-height: 0.75; margin-bottom: 0.5rem;"
          >«</span>

          <PrismicRichText
            :field="slice.primary.manifesto"
            :components="{
              paragraph: {
                class:
                  'font-display italic text-white text-[clamp(1.375rem,3vw,2.125rem)] leading-[1.65] tracking-[-0.02em] m-0',
              },
            }"
          />
          ...
          <motion.div
            ...
            :in-view-options="{ once: true }"
            class="w-10 h-px bg-lumina-300/40 mx-auto mt-10 origin-left"
          />
        </motion.div>
      </UContainer>
    </section>
      ...
      <UContainer>
        ...
        >
          ...
          >
            ...
            >
              <span>{{ slice.primary.cta_link.text || 'Prendre contact' }}</span>
